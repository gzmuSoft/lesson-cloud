 ...
 * 通过 {@link cn.edu.gzmu.auth.sms.SmsAuthenticationFilter} 过滤器进行拦截
 * 获取到需要的参数后，将他封装为我们自己的 {@link org.springframework.security.authentication.AbstractAuthenticationToken}
 * 实现类 {@link cn.edu.gzmu.auth.sms.SmsAuthenticationToken}
 ...
 * <p>
 * 我们需要提供一个他的子类 {@link cn.edu.gzmu.auth.sms.SmsAuthenticationProvider}
 * 并实现接口中所有的方法，使用它来校验授权与用户信息。
 * 依然会去请求数据库，我通过实现自己写的 {@link cn.edu.gzmu.auth.user.SmsUserDetailsService} 接口
