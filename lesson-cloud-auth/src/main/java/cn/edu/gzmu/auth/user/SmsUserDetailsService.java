...
public interface SmsUserDetailsService {
    ...
    /**
     * 根据用户名找到用户。在实际实现中，只用查询手机号即可，对于手机号的验证需要对 {@link cn.edu.gzmu.validate.sms} 进行具体公职
     ...
     * @param sms sms 设备号
     * @return 用户认证信息
     * @throws SmsNotFoundException 用户名未找到
     */
    UserDetails loadUserBySms(String sms) throws SmsNotFoundException;
}
