...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '问答题' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam`  (
  ...
  `is_enable` binary(1) NOT NULL DEFAULT 1 COMMENT '是否可用，1：可用，0：不可用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '考试' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '考试试卷历史记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '试卷组卷规则' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '知识点' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '多项选择题' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '试卷详情及阅卷信息' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '编程题' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sel_options`  (
  ...
  `is_enable` binary(1) NOT NULL DEFAULT 1 COMMENT '是否可用，1：可用，0：不可用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '单项选择题、多项选择题、填空题的选项信息表，一个题目的选项可以有多个，不局限于4个选项' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学期' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_data`  (
  ...
  `is_enable` binary(1) NOT NULL DEFAULT 1 COMMENT '是否可用，1：可用，0：不可用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统基本数据表' ROW_FORMAT = Dynamic;
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (1, '123', '123', '123', '123', '123', '1232', '123', '1', 1, NULL, '2019-04-13 15:03:34', NULL, '2019-04-13 15:18:52', NULL, 0x31);
INSERT INTO `sys_log` VALUES (2, '123', '123', '123', '123', '123', '1232', '123', '1', 1, NULL, '2019-04-13 15:03:34', NULL, '2019-04-13 15:03:42', NULL, 0x31);
...
CREATE TABLE `sys_res`  (
  ...
  `is_enable` binary(1) NOT NULL DEFAULT 1 COMMENT '是否可用，1：可用，0：不可用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限资源' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_res
-- ----------------------------
INSERT INTO `sys_res` VALUES (1, '手机登录', NULL, NULL, 'oauth 手机登录', '/oauth/sms', '-', '-', '-', 0, 'GET', NULL, NULL, NULL, '2019-04-20 17:11:01', NULL, '2019-04-20 17:20:33', NULL, 0x31);
INSERT INTO `sys_res` VALUES (2, '日志管理', NULL, NULL, '获取日志信息', '/sysLogs/**', '/sysLogs', 'sysLogs', NULL, 0, 'GET', NULL, NULL, NULL, '2019-04-20 17:11:55', NULL, '2019-04-20 17:22:54', NULL, 0x31);
INSERT INTO `sys_res` VALUES (3, '日志管理-新增', NULL, NULL, '新增日志信息', '/sysLogs/**', NULL, NULL, NULL, 2, 'POST', NULL, NULL, NULL, '2019-04-20 17:21:09', NULL, '2019-04-20 17:22:54', NULL, 0x31);
INSERT INTO `sys_res` VALUES (4, '日志管理-删除', NULL, NULL, '删除日志信息', '/sysLogs/**', NULL, NULL, NULL, 2, 'DELETE', NULL, NULL, NULL, '2019-04-20 17:22:54', NULL, '2019-04-20 17:22:54', NULL, 0x31);
INSERT INTO `sys_res` VALUES (5, '日志管理-编辑', NULL, NULL, '编辑日志信息', '/sysLogs/**', NULL, NULL, NULL, 2, 'PUT', NULL, NULL, NULL, '2019-04-20 17:22:54', NULL, '2019-04-20 17:22:54', NULL, 0x31);
INSERT INTO `sys_res` VALUES (6, '用户管理', NULL, NULL, '获取用户信息', '/sysLogs/**', NULL, NULL, NULL, 0, 'GET', NULL, NULL, NULL, '2019-04-20 17:22:54', NULL, '2019-04-20 17:22:54', NULL, 0x31);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, 'ROLE_ADMIN', '管理员', '开放所有资源访问权限', 'status_online', 0, 1, 'admin', '2019-04-19 22:48:15', 'admin', '2019-04-20 17:08:39', NULL, 0x31);
INSERT INTO `sys_role` VALUES (2, 'ROLE_ANONYMOUS', '匿名资源', '无需任何认证即可访问', 'status_online', 0, 3, 'admin', '2019-04-20 16:58:45', 'admin', '2019-04-20 17:09:39', NULL, 0x31);
INSERT INTO `sys_role` VALUES (3, 'ROLE_TEACHER', '教师', '开放部分权限', 'status_online', 0, 2, 'admin', '2019-04-19 22:48:25', 'admin', '2019-04-20 17:09:38', NULL, 0x31);
INSERT INTO `sys_role` VALUES (4, 'ROLE_STUDENT', '学生', '开放部分资源', 'status_online', 0, 4, 'admin', '2019-04-20 17:10:10', 'admin', '2019-04-20 17:10:10', NULL, 0x31);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限关联' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '', NULL, 0, '$2a$10$TtwVLF9OMb5/LhZYgC1mAepnQMPoG.rdNWKIrUvn6NlzHvD.jRITW', 1, '图标：images/guest.jpg', 'lizhongyue248@163.com', '13765308262', b'0', 1, 'admin', '2019-04-20 17:07:50', 'admin', '2019-04-20 17:12:45', NULL, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户角色关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user_role
-- ----------------------------
INSERT INTO `sys_user_role` VALUES (1, '管理员权限赋予管理员', NULL, 1, 1, NULL, NULL, '2019-04-20 17:23:12', NULL, '2019-04-20 17:23:12', NULL, 0x31);
