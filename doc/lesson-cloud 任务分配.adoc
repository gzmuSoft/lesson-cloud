...
| logic_class | 逻辑班级 | 待认领 | 未完成
| multi_sel | 多项选择题 | 严宪法 | 未完成
| paper | 试卷 | 李中月 | 未完成
| paper_detail | 试卷详情及阅卷信息 | 待认领 | 未完成
| program | 编程题 | 待认领 | 未完成
| section | 章节 | 待认领 | 未完成
...
| sys_res | 权限资源 | 待认领 | 未完成
| sys_role | 系统角色表 | 待认领 | 未完成
| sys_role_res | 角色权限关联 |  待认领 | 未完成
| sys_user | 系统用户表 | 李中月 | 已完成
| sys_user_role | 用户角色关联 | 待认领 | 未完成
